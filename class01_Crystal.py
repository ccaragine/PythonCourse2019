...
print(cohort[-1]) ## last
print(cohort[len(cohort)]) ## !!! print(cohort) for whole thing

## lists are mutable
cohort[0] = "Alexandra"
print(cohort)

## Insert by index specifies where to replace it 
...
## Like lists, but immutable use () rather than []
## Not super common....
...
## Input, output, def means define the function 
def add_squares(x, y):
	return x**2 + y**2
